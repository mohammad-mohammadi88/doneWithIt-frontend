...
const Footer: FC<Props> = ({ categories }) => {
    return (
        <footer className='container mx-auto px-4 my-4 lg:mb-0'>
            <div className='text-light-300 rounded-xl lg:rounded-b-none flex flex-wrap mx-auto p-3 bg-gray-500'>
                ...
                >
                    ...
                    <p>
                        Done with it is an online shopping application that you
                        can buy stuff you need from all over the world and sell
                        stuff you do not need to every body on world!
                    </p>
                </div>
            </div>
        </footer>
